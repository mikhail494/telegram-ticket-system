...
export function senderTypeForDirection(direction: MessageDirection): MessageSenderType {
  if (direction === "USER_TO_STAFF") return "USER";
  if (direction === "STAFF_TO_USER") return "STAFF";
  return "SYSTEM";
}
...
export function normalizeManagedChatAllowlist(values: readonly string[]): readonly string[] {
